...
#
# from filters import IsDatabaseUserMessage, IsPrivateMessage
# from handlers.users.events_main_parsing import check_events_update
...
#     await message.answer(f"⚠️ There is no new events.")
#
#
#
