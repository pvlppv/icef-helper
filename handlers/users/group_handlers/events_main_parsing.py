...
def check_events_update():
    ...
    # with open("/Users/pavelpopov/PycharmProjects/ICEF Helper/handlers/users/group_handlers/0events_dict.json", "w") as file:
    with open("/root/bot/handlers/users/group_handlers/0events_dict.json", "w") as file:
        json.dump(events_dict, file, indent=5, ensure_ascii=False)
