...
def statistics(user_id, command):
    ...
    with open('/Users/pavelpopov/PycharmProjects/ICEF Helper/data.csv', 'a', newline="") as fil:
...
def analysis(bid, user_id):
    season = int(bid[1])
    df = pd.read_csv('/Users/pavelpopov/PycharmProjects/ICEF Helper/data.csv', delimiter=';', encoding='utf8')
